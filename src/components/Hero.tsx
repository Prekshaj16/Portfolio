        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              ...
              className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg glow-hover"
            >
              View My Work
            </Button>
            <Button 
              ...
              className="border-border hover:bg-accent px-8 py-3 rounded-lg"
            >
              Get In Touch
            </Button>
          </div>
