  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto font-normal text-slate-500"> I am a Full Stack Developer and AI/ML Enthusiast, creating scalable, intelligent applications that blend innovation with efficiency. I craft smart solutions that automate processes and enhance decision-making. 🚀</p>
